...
/**
 * Created by bill on 2020/12/30
 **/
public class COSUtil {

    //此处填写的存储桶名称
    private static final String bucketName = "zml-1318096182";

    //secretId
    private static final String secretId = "AKIDEMVWQG3hFmVN7kClIensy1xzseEeNxTo";

    //secretKey
    private static final String secretKey = "GnDQQG4kHgw46yeAUcAZortKbMLEAxvu";
    ...
    public static String uploadfile(File localFile,String pathPrefix) throws CosClientException, CosServiceException {
        ...
        try {
            ...
            // 指定要上传到 COS 上的路径
            fileName = pathPrefix + "/" + s + substring;
